...
export const INITIAL_DEVICES: readonly Device[] = [
  ...
  /**
   * ปั๊มคูลลิ่งแพดเริ่มต้น **เปิด** — ต้องตรงกับพัดลมใหญ่ #1 ที่เปิดอยู่ข้างบน
   *
   * 🔴 ค่าเริ่มต้นต้องสอดคล้องกันเอง ไม่งั้นตัวตาม (`FarmStateProvider`) จะเห็นว่า
   * "พัดลมเดินแต่ปั๊มดับ" ตั้งแต่เฟรมแรก แล้วยิงคำสั่งแก้ทันทีตอนเปิดหน้า
   * ซึ่งทั้งรกบันทึกการทำงานและทำให้เทสอ่านยากว่าใครเป็นคนสั่ง
   */
  { id: 'pump', type: 'pump', n: 0, on: true, pending: null, online: true, auto: true },
];
