...
ปั๊มออฟไลน์ = สั่งรดน้ำไม่ได้ทั้งฟาร์ม · **ห้ามใส่ตัวเลือกให้ผู้ใช้ตั้ง "รดกี่นาที" ในปุ่มรดน้ำ** (แต่มี auto-cutoff 20 นาทีของระบบเป็น safety ได้ · เป็นค่าตายตัว ไม่ใช่ตัวเลือกผู้ใช้) ·
**ข้อยกเว้นที่อนุมัติแล้ว (2026-08-10):** ปั๊มมีการ์ดใน "เงื่อนไขอัตโนมัติ" ได้ **เฉพาะตารางเวลา** (เวลาเริ่ม-สิ้นสุด · วันในสัปดาห์)
ซึ่งเป็น `setSchedule` ของอุปกรณ์จริง (ยิงที่ ch2 · ไม่ใช่ตัวเลือกบนปุ่มรดน้ำ) · **ห้ามผูกปั๊มกับเกณฑ์อุณหภูมิ** (อากาศร้อน ≠ ดินแห้ง)
🔴 **auto-cutoff 20 นาทีไม่คุมตารางเวลา** — ตัวจับเวลาอยู่ใน `FarmStateProvider` คือในเบราว์เซอร์
ปิดแท็บ = ไม่มีใครตัด แต่ตารางเวลาอยู่ในตัวอุปกรณ์และเดินต่อ · ห้ามเขียนบนจอว่าระบบจะตัดให้เสมอ
(ทางแก้จริงต้องอยู่ฝั่ง backend/อุปกรณ์) — ดู `docs/DESIGN_SOURCE.md` ข้อ 34 ·
...
ประวัติการสั่งงานอยู่ในลิ้นชักหน้าชลประทาน+ฉากเกม · กราฟย้อนหลัง/สมุดบันทึกอยู่แดชบอร์ด ·
...
- **ปั๊ม = ch2 (ต่อ relay จริงแล้ว)** — คุมได้จริง · คง confirm เช็คน้ำ + auto-cutoff 20 นาที
