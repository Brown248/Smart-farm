...
ซึ่งเป็น `setTimer` ของอุปกรณ์จริง ไม่ใช่ตัวเลือกบนปุ่มรดน้ำ · **ห้ามผูกปั๊มกับเกณฑ์อุณหภูมิ** (อากาศร้อน ≠ ดินแห้ง)
auto-cutoff 20 นาทียังคุมอยู่เหนือตารางเวลา ตั้งช่วงยาวกว่านั้นก็หยุดก่อน — ดู `docs/DESIGN_SOURCE.md` ข้อ 34 ·
